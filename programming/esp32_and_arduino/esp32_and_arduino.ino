...
//constexpr char WIFI_SSID[] = "BT-M7AC8X";
//constexpr char WIFI_PASSWORD[] = "VbRv64dvCJHe3x";

constexpr char WIFI_SSID[] = "Ines";
constexpr char WIFI_PASSWORD[] = "thisismypassword";


// See https://thingsboard.io/docs/getting-started-guides/helloworld/
// to understand how to obtain an access token
constexpr char TOKEN[] = "SvKSrn5O5DRJGiRaAAQn";
